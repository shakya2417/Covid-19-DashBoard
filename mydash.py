...
browser_linux={'User-Agent':'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.93 Safari/537.36'}
...
def table_plot(x,y):
    ...
    response = requests.get(URL,headers=browser_linux)
    print(response)
